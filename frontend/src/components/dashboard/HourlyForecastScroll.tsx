...
import { CloudSun, CloudRain, CloudLightning, Sun, Moon } from 'lucide-react';
  ...
  return (
    <section className="bg-white border border-[#DCEAE2] rounded-2xl p-5 shadow-xs space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="font-bold text-[#17352A] text-lg">Hourly Precipitation & Temp</h3>
        <span className="text-xs text-[#6B7D74]">IMD Nowcast Trend</span>
      </div>
        ...
        {hourlyForecast.map((item, index) => (
          ...
          >
            ...
            <div className="text-base font-bold text-[#17352A]">
              {formatTemp(item.temp, preferences.tempUnit)}
            </div>
